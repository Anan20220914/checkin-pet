...
export const CHINESE_WORDS = [
  ...
  // 第三册
  { char: "虫", book: 3, words: ["虫子", "小虫", "昆虫"] },
  { char: "把", book: 3, words: ["一把", "把手", "把关"] },
  { char: "驮", book: 3, words: ["驮着", "驮运", "驮东西"] },
  { char: "鹅", book: 3, words: ["白鹅", "天鹅", "鹅毛"] },
  { char: "河", book: 3, words: ["小河", "河水", "河边"] },
  { char: "礼", book: 3, words: ["礼物", "礼貌", "敬礼"] },
  { char: "背", book: 3, words: ["背上", "背包", "背书包"] },
  { char: "拿", book: 3, words: ["拿着", "拿走", "拿东西"] },
  { char: "里", book: 3, words: ["里面", "家里", "心里"] },
  { char: "后", book: 3, words: ["后面", "以后", "前后"] },
  { char: "谢", book: 3, words: ["谢谢", "感谢", "道谢"] },
  { char: "边", book: 3, words: ["旁边", "河边", "一边"] },
  { char: "貌", book: 3, words: ["礼貌", "面貌", "外貌"] },
  { char: "班", book: 3, words: ["班级", "上班", "值班"] },
  { char: "幼", book: 3, words: ["幼儿", "幼小", "幼儿园"] },
  { char: "园", book: 3, words: ["公园", "花园", "幼儿园"] },
  { char: "照", book: 3, words: ["照片", "照顾", "照亮"] },
  { char: "婆", book: 3, words: ["婆婆", "外婆", "老婆婆"] },
  { char: "甜", book: 3, words: ["甜美", "甜瓜", "香甜"] },
  { char: "梦", book: 3, words: ["做梦", "梦想", "美梦"] },
  { char: "老", book: 3, words: ["老师", "老人", "老家"] },
  { char: "盒", book: 3, words: ["盒子", "纸盒", "盒饭"] },
  { char: "尺", book: 3, words: ["尺子", "直尺", "尺寸"] },
  { char: "刀", book: 3, words: ["小刀", "刀子", "菜刀"] },
  { char: "时", book: 3, words: ["时间", "小时", "时候"] },
  { char: "正", book: 3, words: ["正在", "正确", "立正"] },
  { char: "文", book: 3, words: ["文字", "文化", "语文"] },
  { char: "具", book: 3, words: ["文具", "工具", "玩具"] },
  { char: "笔", book: 3, words: ["铅笔", "毛笔", "笔尖"] },
  { char: "画", book: 3, words: ["画画", "图画", "画报"] },
  { char: "长", book: 3, words: ["长短", "长大", "长江"] },
  { char: "放", book: 3, words: ["放下", "放学", "开放"] },
  { char: "用", book: 3, words: ["用力", "有用", "使用"] },
  { char: "总", book: 3, words: ["总是", "总共", "总结"] },
  { char: "尾", book: 3, words: ["尾巴", "结尾", "鱼尾"] },
  { char: "巴", book: 3, words: ["尾巴", "下巴", "嘴巴"] },
  { char: "玉", book: 3, words: ["玉米", "玉石", "白玉"] },
  { char: "尖", book: 3, words: ["尖尖", "笔尖", "尖刀"] },
  { char: "竹", book: 3, words: ["竹子", "竹林", "竹竿"] },
  { char: "苗", book: 3, words: ["禾苗", "树苗", "幼苗"] },
  { char: "听", book: 3, words: ["听见", "听话", "听说"] },
  { char: "话", book: 3, words: ["说话", "电话", "话语"] },
  { char: "猴", book: 3, words: ["猴子", "小猴", "金丝猴"] },
  { char: "猩", book: 3, words: ["猩猩", "大猩猩", "黑猩猩"] },
  { char: "给", book: 3, words: ["给你", "送给", "还给"] },
  { char: "进", book: 3, words: ["进来", "进步", "走进"] },
  { char: "告", book: 3, words: ["告诉", "报告", "告别"] },
  { char: "电", book: 3, words: ["电话", "电灯", "电视"] },
  { char: "诉", book: 3, words: ["告诉", "诉说", "诉苦"] },
  { char: "念", book: 3, words: ["想念", "念书", "纪念"] },
  { char: "饭", book: 3, words: ["吃饭", "米饭", "早饭"] },
  { char: "乖", book: 3, words: ["乖乖", "乖巧", "乖孩子"] },
  { char: "想", book: 3, words: ["想念", "思想", "想要"] },
  { char: "面", book: 3, words: ["上面", "面前", "面条"] },
  { char: "住", book: 3, words: ["住在", "住房", "记住"] },
  { char: "前", book: 3, words: ["前面", "从前", "向前"] },
  { char: "从", book: 3, words: ["从前", "从来", "从小"] },
  { char: "同", book: 3, words: ["同学", "相同", "一同"] },
  { char: "没", book: 3, words: ["没有", "没事", "没人"] },
  { char: "送", book: 3, words: ["送给", "欢送", "送礼"] },
  { char: "果", book: 3, words: ["水果", "果实", "苹果"] },
  { char: "工", book: 3, words: ["工人", "工作", "工厂"] },
  { char: "厂", book: 3, words: ["工厂", "厂家", "出厂"] },
  { char: "产", book: 3, words: ["生产", "产品", "出产"] },
  { char: "动", book: 3, words: ["动物", "运动", "活动"] },
  { char: "关", book: 3, words: ["关门", "关心", "开关"] },
  { char: "找", book: 3, words: ["找到", "寻找", "找人"] },
  { char: "按", book: 3, words: ["按时", "按住", "按钮"] },
  { char: "年", book: 3, words: ["今年", "过年", "新年"] },
  { char: "节", book: 3, words: ["节日", "春节", "节气"] },
  { char: "桃", book: 3, words: ["桃子", "桃花", "桃树"] },
  { char: "荷", book: 3, words: ["荷花", "荷叶", "荷塘"] },
  { char: "菊", book: 3, words: ["菊花", "秋菊", "赏菊"] },
  { char: "梅", book: 3, words: ["梅花", "梅子", "腊梅"] },
  { char: "冷", book: 3, words: ["寒冷", "冷水", "天冷"] },
  { char: "它", book: 3, words: ["它们", "其它", "它的"] },
  { char: "怕", book: 3, words: ["害怕", "可怕", "怕冷"] },
  { char: "躲", book: 3, words: ["躲藏", "躲开", "躲避"] },
  { char: "勇", book: 3, words: ["勇敢", "勇气", "英勇"] },
  { char: "敢", book: 3, words: ["勇敢", "敢于", "不敢"] },
  { char: "堆", book: 3, words: ["一堆", "堆积", "堆雪人"] },
  { char: "仗", book: 3, words: ["打仗", "胜仗", "仗势"] },
  { char: "柳", book: 3, words: ["柳树", "柳枝", "垂柳"] },
  { char: "农", book: 3, words: ["农民", "农田", "农活"] },
  { char: "民", book: 3, words: ["人民", "农民", "居民"] },
  { char: "伯", book: 3, words: ["伯伯", "大伯", "伯父"] },
  { char: "种", book: 3, words: ["种地", "种子", "种田"] },
  { char: "最", book: 3, words: ["最好", "最大", "最后"] },
];
